...
export type Chapter = {
  ...
  content: string;
  images: ChapterImage[];
  type: 'frontmatter' | 'chapter' | 'backmatter' | 'toc';
  pageNumber?: number;
  indentation: number;
  lineSpacing: number;
...
export type EbookSettings = {
  ...
  fonts: {
    ...
    header: FontSettings;
    footer: FontSettings;
    frontmatterContent: FontSettings;
    chapterContent: FontSettings;
    subchapterContent: FontSettings;
    backmatterContent: FontSettings;
  };
  pageNumbering: {
    enabled: boolean;
    startFrom: number;
